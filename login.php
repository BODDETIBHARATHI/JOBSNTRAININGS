...
{
$con = mysqli_connect("localhost","root","","job");
$sql = "select * from trainer_reg where UserName='".$UserName."' and Password='".$Password."' and Status='Confirm'";
$result = mysqli_query($con,$sql);
$records = mysqli_num_rows($result);
$row = mysqli_fetch_array($result);
if ($records==0)
...
$_SESSION['Name']=$row['InstituteName'];
$_SESSION['$UserName_trainer']=$UserName;
