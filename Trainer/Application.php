...
$query_Recordset1 = sprintf("SELECT CourseId, CourseTitle FROM training_master WHERE InstituteName = %s", GetSQLValueString($colname_Recordset1, "text"));
$Recordset1 = mysqli_query($con,$query_Recordset1) or die(mysqli_error());
$row_Recordset1 = mysqli_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysqli_num_rows($Recordset1);


$query_Recordset2 = "SELECT coaching_master.CoachingId, coaching_master.Status, jobseeker_reg.JobSeekerName, jobseeker_reg.City, jobseeker_reg.Email, coaching_master.CourseId FROM coaching_master, jobseeker_reg WHERE jobseeker_reg.JobSeekId=coaching_master.JobSeekId";
...
do {  
?>
                          <option value="<?php echo $row_Recordset1['CourseId']?>"><?php echo $row_Recordset1['CourseTitle']?></option>
                          <?php
...
$sql = "SELECT coaching_master.CoachingId, coaching_master.Status, 

jobseeker_reg.JobSeekerName, jobseeker_reg.City, jobseeker_reg.Email, jobseeker_reg.JobSeekId,

coaching_master.CourseId
FROM coaching_master, jobseeker_reg
WHERE jobseeker_reg.JobSeekId=coaching_master.JobSeekId and coaching_master.CourseId='".$Title."'";
...
?>
                  <tr>
                    ...
                    <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Status;?></strong></div></td>
                     <td class="style3"><div align="left" class="style9 style5"><strong></strong><a href="ViewBiodata.php?JobSeekId=<?php echo $JobSeekId; ?>&AppId=<?php echo $Id;?>&CourseId=<?php echo $Title;?>&Status=<?php echo $Status;?>">View</a></div></td>
                  </tr>
                  <?php
}
