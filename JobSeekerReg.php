...
<head>
    ...
    <title>Welcome To JOBSNTRAININGS Portal</title>
...
event.target.setCustomValidity('Username should only contain lowercase letters.E.G.Bharathi');
}
// <!-- <![CDATA[
...
///////////////////////////
var chkdate = document.getElementById("txtBirthDate").value;
checkDate(chkdate);
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><span id="sprytextfield3">
                        <label>
                        <input type="text" name="txtName" id="txtName" pattern="[A-Za-z]{1,32}" title="Name field should only contain letters.e.g. Bharathi" />
                        </label>
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextfield6">
                        <label>
                        <input type="text" name="txtMobile" id="txtMobile" maxlength="10" />
                        </label>
                 ...
                 <!--   <tr>
                    ...
                    <tr>
                      ...
                      <td><label><span id="sprytextfield9">
                        <input type="password" name="txtPassword" id="txtPassword" maxlength="10" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
