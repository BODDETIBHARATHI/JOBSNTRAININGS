...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Welcome To JobNtrainings Portal System</a></span></h2>
				<h3><marquee>Welcome To JobNtrainings Portal System</marquee></h3>
              ...
              <p>This Portal is designed for the various employer who required to recruit employees in their organization. Employer can registered himself on the web portal and then he can upload information of various job vacancies in their organization. Employeer can view the applications of Job Seeker and send call latter to the job seekers.</p>
              <p>This Portal is also designed for the various trainings institutes who required to grab trainees into their institutes. Trainer can registered himself on the web portal and then he can upload information of various course trainings in their institutions. Trainer can view the applications of trainees and send the details about the trainings.</p>
