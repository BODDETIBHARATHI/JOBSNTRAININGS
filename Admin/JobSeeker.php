...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="EditJobseeker.php?JobSeekId=<?php echo $row['JobSeekId'];?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteJobSeeker.php?JobSeekId=<?php echo $row['JobSeekId'];?>">Delete</a></strong></div></td>
</tr>
<?php
}
