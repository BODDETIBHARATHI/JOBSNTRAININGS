                                ...
                                <table width="100%" border="1" bordercolor="#1CB5F1">
                                    <tr>
                                        ...
                                        <th bgcolor="#1CB5F1" class="style3">
                                            <div align="left" class="style9 style5"><strong>Institute Name</strong></div>
                                        </th>
                                        <th bgcolor="#1CB5F1" class="style3">
                                    ...
                                    $sql = "select * from Trainer_Reg where Status='Pending'";
                                    // Execute query
                                        ...
                                        <tr>
                                            ...
                                            <td class="style3">
                                                <div align="left" class="style9 style5"><strong><a
                                                            href="DetailTrainer.php?TrainerId=<?php echo $Id; ?>">Detail</a></strong>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
