...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="EditEmployer.php?EmployerId=<?php echo $row['EmployerId'];?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteEmployer.php?EmployerId=<?php echo $row['EmployerId'];?>">Delete</a></strong></div></td>
</tr>
<?php
}
