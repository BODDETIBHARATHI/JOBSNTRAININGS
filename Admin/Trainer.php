...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Our Trainers</a></span></h2>
...
$sql = "select * from trainer_reg where Status='Confirm'";
// Execute query
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="EditTrainer.php?TrainerId=<?php echo $row['TrainerId'];?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteTrainer.php?TrainerId=<?php echo $row['TrainerId'];?>">Delete</a></strong></div></td>
</tr>
<?php
}
...
?>
                ...
                <div align="center"><a href="TrainerReg.php"><strong>New Trainer? Register Here</strong></a>
                  </div>
