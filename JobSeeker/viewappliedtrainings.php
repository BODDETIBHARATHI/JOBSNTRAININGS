...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
               <h2><span><a href="#">Welcome <?php echo $_SESSION['$UserName_job'];?></a></span></h2>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <!-- <tr>
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Posted Training </strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        <th height="32" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Id</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Institute Name</strong></div></th>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Status of Trainings</strong></td>
                  </tr>
                  <tr>
...
$sql = "SELECT training_master.CourseId, training_master.InstituteName, training_master.CourseTitle, training_master.Fee, training_master.Timings, coaching_master.JobSeekId, coaching_master.Description
