...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                    <h2><span><a href="#">Welcome To Job Seeker</a></span></h2>
...
?>
<form method="post" action="UpdateJobSeeker.php">
                <table width="100%" height="200" border="1" cellspacing="2" cellpadding="2">
               <!--   <tr>
             ...
             <tr>
                  ...
                  <!--  <td><strong>Gender:</strong></td>
                    <td><span id="sprytextfield8">
                      <label>
                      <input name="cmbGender" type="text" id="txtUser" value="<?php echo $row['Gender'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
                    ...
                    <td><span id="sprytextfield9">
                      <label>
                      <input name="txtPassword" type="password" id="txtPassword" value="<?php echo $row['BirthDate'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>   -->
