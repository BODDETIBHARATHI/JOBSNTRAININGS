        ...
        <div id="content">
            ...
            <div class="article">
              <!-- <h2><span><a href="#">Welcome <?php echo $_SESSION['$UserName_job'];?></a></span></h2>-->
                <h2><span><a href="#">Welcome Job seeker</a></span></h2>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <!-- <tr>
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Posted Jobs </strong></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        <th height="32" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Company Name</strong></div></th>
