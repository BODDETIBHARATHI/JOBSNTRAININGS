...
//<?php
//session_start();
//if(isset($_SESSION['$UserName_training'])){
...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
              <!-- <h2><span><a href="#">Welcome <?php echo $_SESSION['$UserName_training'];?></a></span></h2>-->
                <h2><span><a href="#">Welcome to JOBSNTRAININGS</a></span></h2>
               ...
               <!--  <tr>
                  ...
                  <tr>
                    <td><table width="70%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        <th height="32" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Institute Name</strong></div></th>
                        ...
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Fee</strong></div></th>
                         <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>SeatAvailable</strong></div></th>
...
$sql = "select * from training_Master";
// Execute query
...
?>
			...
			<tr>      <!-- <td class="style3"><div align="left" class="style9 style5"><strong><a href="Apply.php?JobId=<?php echo $Id;?>">Apply</a></strong></div></td>-->  
                        <td colspan="6" class="style3"><div align="center" class="style9 style5"><strong><center><a href="ApplyTraining.php?CourseId=<?php echo $Id;?>"></center>Apply</a></strong></div></td>                  
                      </tr>
                      <?php
}
