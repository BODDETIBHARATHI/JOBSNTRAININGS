                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><span id="sprytextfield3">
                        <label>
                        <input type="text" name="txtName" id="txtName" pattern="[A-Za-z]{1,32}" title="Name field should only contain letters.e.g. Google" />
                        </label>
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextfield8">
                        <label>
                        <input type="text" name="txtPerson" id="txtPerson" pattern="[A-Za-z]{1,32}" title="Name field should only contain lowercase letters.e.g. Bharathi"/>
                        </label>
