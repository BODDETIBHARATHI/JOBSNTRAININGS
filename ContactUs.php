            ...
            <div class="article">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="94%"><strong>JobsNtrainings.com<br/>
                    Hyderabad,<br/>
                    Telangana, India<br/>
                    Pincode:500014</strong></td>
                  </tr>
                  <tr>
                    <td><img src="design/ico_archive2.gif" alt="" width="9" height="11" /></td>
					<td><strong>Office No: 040-180-1234<b>
					Mobile: +919897968954
					</strong></td>
                  ...
                  <tr>
                    <td><img src="design/ico_archive2.gif" alt="" width="9" height="11" /></td>
                    <td><strong>Email: JobsNtraining@gmail.com</strong></td>
                  </tr>
                  <tr>
                    <td><img src="design/ico_archive2.gif" alt="" width="9" height="11" /></td>
                    <td><strong>Website:JobsNtraining.com/india</strong></td>
                  </tr>
			<tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Provide us comments :</strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertComment.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
